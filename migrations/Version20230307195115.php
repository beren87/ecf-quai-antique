 ...
 */
final class Version20230307195115 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_dishe (categorie_id INT NOT NULL, dishe_id INT NOT NULL, INDEX IDX_DF8DD1B89EA120EE (dishe_id), INDEX IDX_DF8DD1B8BCF5E72D (categorie_id), PRIMARY KEY(categorie_id, dishe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
