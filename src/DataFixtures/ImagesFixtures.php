...
class ImagesFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $images->setFile('images/Matouille-de-Savoie.png');
        ...
        $images->setFile('images/fondu-plan-01.png');
        $manager->persist($images);
        ...
        $images->setFile('images/Parfum-campagnes-verdures.png');
        $manager->persist($images);
        ...
        $images->setFile('images/chef-cuisinier-02.png');
        $manager->persist($images);
        ...
        $images->setFile('images/cuisinier-02.png');
        $manager->persist($images);
        ...
        $images->setFile('images/cuisinier-01.png');
        $manager->persist($images);
        ...
        $images->setFile('images/cuisinier-03.png');
        $manager->persist($images);
        ...
        $images->setFile('images/cocktail-fresh.png');
        $manager->persist($images);
        ...
        $images->setFile('images/services.png');
        $manager->persist($images);
        ...
        $images->setFile('images/herd-cows.png');
        $manager->persist($images);
        ...
        $images->setFile('images/beautiful-lake.png');
        $manager->persist($images);
        ...
        $images->setFile('images/vignes-chambery.png');
        $manager->persist($images);
